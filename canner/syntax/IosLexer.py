...
class IosLexer(RegexLexer):
    ...
    tokens = {
        ...
        'commands': [
            ...
            (r'route-map(?=\s)', Keyword, ('route-map', 'slurp', 'litString')),
            (r'router(?=\s)', Keyword, 'router'),
            (r'scheduler(?=\s)', Keyword, 'slurp'),
            (r'sensor(?=\s)', Keyword, 'slurp'),
