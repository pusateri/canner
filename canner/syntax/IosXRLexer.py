...
class IosXRLexer(RegexLexer):
    ...
    aliases = ['iosxr', 'IOS XR configuration file']
    filenames = ['*.xrcfg']
    ...
    tokens = {
        ...
        'commands': [
            ...
            (r'aaa(?=\s)', Keyword, 'aaa'),
            (r'alias(?=\s)', Keyword, ('slurp', 'litString')),
            (r'as-path-set(?=\s)', Keyword, ('as-path-set', 'litString')),
            ...
            (r'multicast-routing(?=\s)', Keyword, 'multicast-routing'),
            (r'ntp(?=\s)', Keyword, 'ntp'),
            (r'prefix-set(?=\s)', Keyword, ('prefix-set', 'litString')),
            (r'router(?=\s)', Keyword, 'router'),
            (r'route-policy(?=\s)', Keyword, ('route-policy', 'litString')),
            ...
            (r'username(?=\s)', Keyword, ('username', 'litString')),
            (r'vrf(?=\s)', Keyword, ('vrf', 'litString')),
            (r'vty-pool(?=\s)', Keyword, 'slurp'),
            ],
        ...
        'as-path-set': [
            (r'\s', Whitespace),
            (r'^end-set', Keyword, '#pop'),
            (r'ios-regex', Keyword, 'slurp'),
            ],
        ...
        'multicast-address-family-interface': [
            (r'\s', Text),
            (r'!.*', Comment),
        ...
        'route-policy': [
            (r'\s', Whitespace),
            (r'^end-policy', Keyword, '#pop'),
            (r'apply', Keyword, 'slurp'),
            (r'drop', Keyword, 'slurp'),
            (r'elseif', Keyword, 'slurp'),
            (r'else', Keyword, 'slurp'),
            (r'endif', Keyword, 'slurp'),
            (r'if', Keyword, 'slurp'),
            (r'pass', Keyword, 'slurp'),
            (r'set', Keyword, 'slurp'),
            ],
        ...
        'router': [
            ...
            (r'msdp(?=\s)', Keyword, 'msdp'),
            (r'ospf(?=\s)', Keyword, ('ospf', 'litString')),
        ...
        'bgp neighbor': [
            ...
            (r'address-family(?=\s)', Keyword, ('bgp neighbor address-family', 'address-family-options')),
        ...
        'bgp neighbor address-family': [
            ...
            (r'send-community-ebgp(?=\s)', Keyword, 'slurp'),
            (r'send-extended-community-ebgp(?=\s)', Keyword, 'slurp'),
            (r'(?=\S+)', EndOfMode, '#pop'),
            ],
        ...
        'isis': [
            ...
            (r'nsf(?=\s)', Keyword, 'slurp'),
            (r'no(?=\s)', Operator.Word),
            (r'partition(?=\s)', Keyword, 'slurp'),
            (r'passive-interface(?=\s)', Keyword, 'slurp'),
            (r'passive(?=\s)', Keyword, 'slurp'),
            ...
            (r'single-topology(?=\s)', Keyword, 'slurp'),
        ...
        'msdp': [
            ...
            (r'\s', Text),
            (r'!.*', Comment),
            (r'cache-sa-holdtime', Keyword, 'slurp'),
            (r'cache-sa-state', Keyword, 'slurp'),
            (r'connect-source', Keyword, 'litInterfaceName'),
            (r'maximum external-sa', Keyword, 'litInteger'),
            (r'maximum peer-external-sa', Keyword, 'litInteger'),
            (r'default-peer', Keyword, 'litAddress'),
            (r'originator-id', Keyword, 'slurp'),
            (r'peer', Keyword, 'litAddress'),
        ...
        'pim': [
            ...
            (r'\s', Text),
            (r'!.*', Comment),
            (r'address-family', Keyword, 'address-family'),
            (r'vrf', Keyword, 'litString'),
        ...
        'template': [
            (r'^\s+', Whitespace),
            (r'\s', Text),
            (r'end-template', Keyword, '#pop'),
            (r'!.*', Comment),
            (r'hostname(?=\s)', Keyword, 'slurp'),
            (r'no(?=\s)', Operator.Word),
            ],
