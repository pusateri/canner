#
# This file is taken directly from the Python standard library
# (Lib/plat-mac/plistlib.py) and is included here for convienence on
# other platforms.  The official Python license is available at
